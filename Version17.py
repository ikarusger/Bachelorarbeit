...
if __name__ == "__main__": 
    ...
    OD = None
    if finalduse is not None and finalkippachse is not None: #Berechne den Abstand zwischen des Düsenschnittpunkts mit dem Bauteils und der Kippachse. Funktioniert nur für DusenU, weil  der Abstand zwischen Duse und Kippachse in x z Richtung bleibt und nicht Dreidimensional ist.
        ds = np.array(finalduse["surface"], dtype=float) # ds ist der Düsenschnittpunkt
        ...
        kante_len2 = np.dot(kab, kab) #Länge der Kanten hoch zwei Skalarprodukt
        ...
        closest = ka + prof * kab #Der nächste Punkt auf der Kante zu ds
