...
if __name__ == "__main__": 
    ...
    #Berechnung von OD
    OD = None
     #Berechne den Abstand zwischen des Düsenschnittpunkts mit dem Bauteils und der Kippachse. Funktioniert nur für DusenU, weil  der Abstand zwischen Duse und Kippachse in x z Richtung bleibt und nicht Dreidimensional ist.
